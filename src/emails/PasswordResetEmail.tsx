    ...
    <html>
      <body style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", backgroundColor: "#0a0a0f", color: "#e2e8f0", padding: "40px 20px" }}>
        <div style={{ maxWidth: 480, margin: "0 auto", backgroundColor: "#111827", borderRadius: 12, padding: 40, border: "1px solid #1e293b" }}>
          ...
          <h2 style={{ color: "#f1f5f9", fontSize: 20, marginBottom: 16 }}>Reset your password</h2>
          <p style={{ color: "#94a3b8", lineHeight: 1.6, marginBottom: 24 }}>
            We received a request to reset your password. Click the button below to choose a new password. This link will expire in{" "}
            <strong style={{ color: "#e2e8f0" }}>1 hour</strong>.
          </p>
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            <a href={resetLink} style={{ display: "inline-block", background: "linear-gradient(135deg, #6366f1, #8b5cf6)", color: "white", textDecoration: "none", padding: "14px 32px", borderRadius: 8, fontWeight: 600, fontSize: 16 }}>
              Reset Password
            </a>
          </div>
